...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-06-2021 a las 22:25:06
...
(1, 'Josué ', 'García', 'García', 'cjgg123@gmail.com', 'Activo', 'cjgg123', '0cc175b9c0f1b6a831c399e269772661');
...
INSERT INTO `grupo_alumnos` (`id`, `id_curso`, `id_alumno`, `id_maestro`, `id_periodo`, `calificacion`) VALUES
(1, 2, 1, 1, 1, 7),
(2, 2, 2, 1, 1, 7),
(3, 2, 3, 1, 1, 9),
(4, 1, 1, 2, 1, 10);
...
(1, 'Sandra', 'Qui', 'Orozco', 56, 'sanQO@gmail.com', 'Activo', 'sanQO', '0cc175b9c0f1b6a831c399e269772661'),
(2, 'yop', 'Elmer', 'Omero', 56, 'YelR@gmail.com', 'Activo', 'yElMero', '0cc175b9c0f1b6a831c399e269772661');
...
ALTER TABLE `grupo_alumnos`
  ...
  ADD CONSTRAINT `grupo_alumnos_ibfk_3` FOREIGN KEY (`id_maestro`) REFERENCES `u_maestros` (`id`),
