...
<head>
	...
	<title>Inicio de sesion Maestros</title>
...
<body>
	...
	<section class="form-login">
		<h5>
			Inicio de sesión Maestros
		</h5>
		<form action="sesionMaestros.php" method="post" >
		...
		<p><a href="formularioMaestros.php">Registrarse</a></p>
