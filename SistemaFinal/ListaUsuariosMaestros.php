...
<html>
<head>
	<title>Listado Usuarios Mestros </title>
	<meta charset="utf-8">
...
<body>
	...
	<table>
		<caption>Listado de Maestros usuarios</caption>
		<thead>
			<tr>
				<th> Id</th>
				<th> Email</th>
		...
		<tbody align="center">
			...
			while ($fila = mysqli_fetch_array($datos)) {
				...
				echo "<tr>";
					...
					echo "<td>  
				     <a  href='editarMaestros.php?id=".$fila['id']."'> Editar </a>
				     <a href='eliminarMaestros.php?id=".$fila['id']."'> Eliminar</a>   
				     </td>";
